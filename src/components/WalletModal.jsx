...
export default function WalletModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      {/* Modal — снизу на мобильном, по центру на десктопе */}
      <div className="relative w-full sm:max-w-sm animate-slide-up" style={{ maxHeight: '90vh', overflowY: 'auto' }}>
          ...
          <div className="bg-dark-300 p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                ...
                className="w-10 h-10 rounded-lg bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors text-white"
