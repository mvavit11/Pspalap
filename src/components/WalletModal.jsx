...
export default function WalletModal({ onClose }) {
  ...
  const handleSelect = useCallback(async (wallet) => {
    ...
    // Small delay so adapter registers the selection, then connect
    setTimeout(async () => {
      try {
        await connect()
      } catch (e) {
          ...
          <div className="bg-dark-300 p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                ...
                style={{ cursor: 'pointer', flexShrink: 0, zIndex: 100002, position: 'relative' }}
                ...
                <div className="space-y-2">
                  {installedWallets.map((wallet) => (
                    <button
                      ...
                      onClick={(e) => { e.stopPropagation(); handleSelect(wallet) }}
                      disabled={connecting}
            ...
            <div className="mt-5 pt-4 border-t border-white/5 space-y-3">
              ...
              >
                ...
                <span style={{ color: '#29B6F6', fontSize: '14px', fontFamily: 'monospace', fontWeight: 600 }}>
                  Support @mv0898
                </span>
              </a>
            </div>
  ...
  // Render modal directly into document.body via portal
  // This bypasses ALL parent z-index and overflow issues
