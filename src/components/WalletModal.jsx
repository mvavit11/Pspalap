...
export default function WalletModal({ onClose }) {
  ...
  return (
    <div
      ...
      onMouseDown={(e) => {
        // Закрыть при клике на backdrop (не на саму карточку)
        if (e.target === e.currentTarget) onClose()
      }}
    >
      <div
        style={{ width: '100%', maxWidth: '384px', position: 'relative' }}
          ...
          <div className="bg-dark-300 p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                ...
                style={{ cursor: 'pointer', flexShrink: 0, zIndex: 1 }}
            ...
            <div className="mt-5 pt-4 border-t border-white/5 space-y-3">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-2.5 px-4 rounded-xl border transition-all duration-200"
                style={{
              ...
              >
                <svg style={{ width: 16, height: 16, flexShrink: 0 }} viewBox="0 0 24 24" fill="#29B6F6">
